...
var format_CNG_14 = new ol.format.GeoJSON();
var features_CNG_14 = format_CNG_14.readFeatures(json_CNG_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CNG_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_CNG_14.addFeatures(features_CNG_14);
var lyr_CNG_14 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_CNG_14, 
                style: style_CNG_14,
                popuplayertitle: "CỐNG",
                interactive: true,
                title: '<img src="styles/legend/CNG_14.png" /> CỐNG'
            });
...
var format_HGA_16 = new ol.format.GeoJSON();
var features_HGA_16 = format_HGA_16.readFeatures(json_HGA_16, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_HGA_16 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_HGA_16.addFeatures(features_HGA_16);
var lyr_HGA_16 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_HGA_16, 
                style: style_HGA_16,
                popuplayertitle: "HỐ GA",
                interactive: true,
                title: '<img src="styles/legend/HGA_16.png" /> HỐ GA'
            });
var group_group1 = new ol.layer.Group({
                                layers: [lyr_GoogleSatellite_0,lyr_NHAMAY_1,lyr_MATNUOC_2,lyr_CHUNGCU_3,lyr_HANHCHINH_4,lyr_TTVH_5,lyr_CHO_6,lyr_CAYXANG_7,lyr_BIETTHU_8,lyr_TRUONGHOC_9,lyr_LIENKE_10,lyr_DUONG_11,lyr_CAYXANH_12,lyr_HLDIEN_13,lyr_CNG_14,lyr_LUUVUC_15,lyr_HGA_16,],
                                fold: "open",
                                title: "group1"});

lyr_GoogleSatellite_0.setVisible(true);lyr_NHAMAY_1.setVisible(true);lyr_MATNUOC_2.setVisible(true);lyr_CHUNGCU_3.setVisible(true);lyr_HANHCHINH_4.setVisible(true);lyr_TTVH_5.setVisible(true);lyr_CHO_6.setVisible(true);lyr_CAYXANG_7.setVisible(true);lyr_BIETTHU_8.setVisible(true);lyr_TRUONGHOC_9.setVisible(true);lyr_LIENKE_10.setVisible(true);lyr_DUONG_11.setVisible(true);lyr_CAYXANH_12.setVisible(true);lyr_HLDIEN_13.setVisible(true);lyr_CNG_14.setVisible(true);lyr_LUUVUC_15.setVisible(true);lyr_HGA_16.setVisible(true);
...
lyr_CNG_14.set('fieldAliases', {'ID': 'ID', 'CHIỀU DÀI (m)': 'CHIỀU DÀI (m)', 'ĐƯỜNG KÍNH (mm)': 'ĐƯỜNG KÍNH (mm)', 'ĐỘ DỐC (i%)': 'ĐỘ DỐC (i%)', 'Q=MƯA (L/S)': 'Q=MƯA (L/S)', 'Q=CỐNG (L/S)': 'Q=CỐNG (L/S)', 'VẬN TỐC (M/S)': 'VẬN TỐC (M/S)', 'H/D (%) 5 NĂM': 'H/D (%) 5 NĂM', 'H/D (%) 20 NĂM': 'H/D (%) 20 NĂM', 'NGÀY LẮP ĐẶT': 'NGÀY LẮP ĐẶT', 'NGÀY BẢO TRÌ': 'NGÀY BẢO TRÌ', 'GHI CHÚ': 'GHI CHÚ', });
lyr_LUUVUC_15.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'SHAPE_Length': 'SHAPE_Length', });
lyr_HGA_16.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'SHAPE_Length': 'SHAPE_Length', });
...
lyr_CNG_14.set('fieldImages', {'ID': 'TextEdit', 'CHIỀU DÀI (m)': 'TextEdit', 'ĐƯỜNG KÍNH (mm)': 'TextEdit', 'ĐỘ DỐC (i%)': 'TextEdit', 'Q=MƯA (L/S)': 'TextEdit', 'Q=CỐNG (L/S)': 'TextEdit', 'VẬN TỐC (M/S)': 'TextEdit', 'H/D (%) 5 NĂM': 'Range', 'H/D (%) 20 NĂM': 'TextEdit', 'NGÀY LẮP ĐẶT': 'DateTime', 'NGÀY BẢO TRÌ': 'DateTime', 'GHI CHÚ': 'TextEdit', });
lyr_LUUVUC_15.set('fieldImages', {'OBJECTID': 'TextEdit', 'SHAPE_Length': 'TextEdit', });
lyr_HGA_16.set('fieldImages', {'OBJECTID': 'TextEdit', 'SHAPE_Length': 'TextEdit', });
...
lyr_CNG_14.set('fieldLabels', {'ID': 'header label - always visible', 'CHIỀU DÀI (m)': 'header label - always visible', 'ĐƯỜNG KÍNH (mm)': 'header label - always visible', 'ĐỘ DỐC (i%)': 'header label - always visible', 'Q=MƯA (L/S)': 'header label - always visible', 'Q=CỐNG (L/S)': 'header label - always visible', 'VẬN TỐC (M/S)': 'header label - always visible', 'H/D (%) 5 NĂM': 'header label - always visible', 'H/D (%) 20 NĂM': 'header label - always visible', 'NGÀY LẮP ĐẶT': 'header label - always visible', 'NGÀY BẢO TRÌ': 'header label - always visible', 'GHI CHÚ': 'header label - always visible', });
lyr_LUUVUC_15.set('fieldLabels', {'OBJECTID': 'header label - visible with data', 'SHAPE_Length': 'header label - visible with data', });
lyr_HGA_16.set('fieldLabels', {'OBJECTID': 'header label - visible with data', 'SHAPE_Length': 'header label - visible with data', });
lyr_HGA_16.on('precompose', function(evt) {
